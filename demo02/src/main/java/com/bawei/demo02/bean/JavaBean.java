...
public class JavaBean {
    ...
    public static class ResultBean {
        /**
         * commodityId : 86
         * commodityName : 韩版装冬装春秋冬小清新学院风皮毛一体翻领短款加绒加厚机车服夹克外套
         * masterPic : http://172.17.8.100/images/small/commodity/nz/wt/1/1.jpg
         * price : 199
         * saleNum : 0
         */
